...
export type StorageHash =
  StorageHashBase<'7908adbc6b612e162ba7c7fc53e2f3ab4b81254dcaf88c1c4a84122e308d0888'>;
export type ExecutionHash =
  ExecutionHashBase<'fd61ea8ab8b373d170cb3ef1a4c3f58519eba6bafde32bbbaa076e68a1fbdb45'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly ReorderSuggestion: {
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly productId: CodecTypes['pg/text@1']['output'];
      readonly productName: CodecTypes['pg/text@1']['output'];
      readonly locationId: CodecTypes['pg/text@1']['output'];
      readonly quantityAvailable: CodecTypes['pg/int4@1']['output'];
      readonly reorderPoint: CodecTypes['pg/int4@1']['output'];
      readonly suggestedQuantity: CodecTypes['pg/int4@1']['output'];
      readonly status: 'OPEN' | 'DISMISSED' | 'CONVERTED';
      readonly purchaseOrderId: CodecTypes['pg/text@1']['output'] | null;
      readonly dismissedBy: CodecTypes['pg/text@1']['output'] | null;
      readonly dismissReason: CodecTypes['pg/text@1']['output'] | null;
      readonly lastReportedAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
  };
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly ReorderSuggestion: {
      ...
      readonly quantityAvailable: CodecTypes['pg/int4@1']['input'];
      readonly reorderPoint: CodecTypes['pg/int4@1']['input'];
      readonly suggestedQuantity: CodecTypes['pg/int4@1']['input'];
      readonly status: 'OPEN' | 'DISMISSED' | 'CONVERTED';
      readonly purchaseOrderId: CodecTypes['pg/text@1']['input'] | null;
      readonly dismissedBy: CodecTypes['pg/text@1']['input'] | null;
      readonly dismissReason: CodecTypes['pg/text@1']['input'] | null;
      readonly lastReportedAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
  };
      ...
      readonly public: {
        ...
        readonly entries: {
          ...
          readonly valueSet: {
            ...
            readonly ReorderSuggestionStatus: {
              readonly kind: 'valueSet';
              readonly values: readonly ['OPEN', 'DISMISSED', 'CONVERTED'];
            };
          };
        };
      };
...
> & {
  ...
  readonly roots: {
    ...
    readonly reorderSuggestion: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'ReorderSuggestion';
    };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          ...
          readonly ReorderSuggestion: {
            ...
            readonly relations: Record<string, never>;
            readonly storage: {
              readonly table: 'reorderSuggestion';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly productId: { readonly column: 'productId' };
                ...
                readonly quantityAvailable: { readonly column: 'quantityAvailable' };
                readonly reorderPoint: { readonly column: 'reorderPoint' };
                readonly suggestedQuantity: { readonly column: 'suggestedQuantity' };
                readonly status: { readonly column: 'status' };
                readonly purchaseOrderId: { readonly column: 'purchaseOrderId' };
                readonly dismissedBy: { readonly column: 'dismissedBy' };
                readonly dismissReason: { readonly column: 'dismissReason' };
                readonly lastReportedAt: { readonly column: 'lastReportedAt' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
