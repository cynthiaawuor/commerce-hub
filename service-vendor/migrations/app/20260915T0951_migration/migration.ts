#!/usr/bin/env -S node
import type { Contract as End } from '../../snapshots/53b2b725a286680c2cb4fd0b2060f9de691febf38d0dd8f95e60250998b1b5e2/contract';
import endContract from '../../snapshots/53b2b725a286680c2cb4fd0b2060f9de691febf38d0dd8f95e60250998b1b5e2/contract.json' with { type: 'json' };
  ...
  override get operations() {
    return [
      ...
      this.addUnique({
        schema: 'public',
        table: 'catalogItem',
        constraint: 'catalogItem_supplierId_key',
        columns: ['supplierId'],
      }),
      this.addUnique({
        schema: 'public',
        table: 'catalogItem',
        constraint: 'catalogItem_productId_key',
        columns: ['productId'],
      }),
      this.addUnique({
        schema: 'public',
