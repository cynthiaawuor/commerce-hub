// Copied verbatim from service-procurement/src/core/. Keep the copies in step:
...
function errorHandler(
  ...
  // Anything else is unexpected: log the real error, send the client a generic message
  console.error(err);
